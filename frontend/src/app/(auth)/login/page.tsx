...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center lg:justify-between overflow-hidden bg-slate-950">
      ...
      <div className="hidden lg:flex flex-col relative z-10 w-full max-w-2xl pl-12 xl:pl-32 group">
      ...
      <div className="w-full max-w-md px-4 z-10 lg:mr-[8%] xl:mr-[12%] shrink-0">
        ...
        <div className="relative group animate-in fade-in zoom-in-95 duration-700 delay-150 fill-mode-both">
          ...
          <div className="bg-slate-950/60 backdrop-blur-2xl border border-cyan-500/30 rounded-2xl shadow-[0_0_40px_rgba(34,211,238,0.15)] overflow-hidden p-8 relative z-10">
